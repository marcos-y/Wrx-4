...
const VehiclePartInfoModal = (props) => {
  ...
  return (
    <Dialog
      ...
      fullScreen={true}
    >
      <CustomTabs variant="scrollable" options={tabOptions} value={tabOptions.indexOf(selectedTab)} handleTabSelect={setselectedTab} />
      <Container disableGutters style={{ minHeight: 400 }}>
        {activeInformation}
      </Container>
      {alert.open && (
